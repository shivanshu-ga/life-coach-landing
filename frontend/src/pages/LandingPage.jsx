              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-50">lifecs.in@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="bg-white/20 p-3 rounded-lg">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-slate-400 mb-2">lifecs.in@gmail.com</p>
                  ...
                  <div className="bg-slate-50 rounded-xl p-6 text-center space-y-4">
                    ...
                    <div className="pt-6 border-t border-slate-200 mt-6">
                      <p className="text-sm text-slate-500">
                        <strong>Phone:</strong> +91 72988 88880 | <strong>Email:</strong> lifecs.in@gmail.com
                      </p>
                    </div>
                  </div>
                </div>
